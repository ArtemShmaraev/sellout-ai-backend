...
from .views import SizeTableForFilter, DewuInfoListView, DewuInfoView, ProductSearchView, ProductSlugView, \
    ...
    SGInfoListSkuView, SGInfoListView, SGInfoView, BrandSearchView, AddFilterSearch, AvailableSize, UpdatePrice, PopularSpuIdView, HideProductView
...
urlpatterns = [
    ...
    path("popular_spu_id", PopularSpuIdView.as_view()), path("hide_product/<int:spu_id>/<int:property_id>", HideProductView.as_view())]
