...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        def add_rec():
            Product.objects.filter(is_recommend=True).update(is_recommend=False)

            d = {"Все кроссовки": 450, "Кеды": 200, "Туфли на высоком каблуке": 20, "Лоферы": 20,
                 "Мокасины и топсайдеры": 20, "Слипоны": 20, "Сандалии и босоножки": 50, "Пляжные сандалии": 50,
                 "Шлёпки и тапки": 20, "Мюли и сабо": 30, "Все туфли": 20, "Футболки": 100, "Лонгсливы": 50,
                 "Все худи и толстовки": 70,
                 "Шорты": 70, "Треники": 70,
                 ...
                 "Кардхолдеры": 30, "Вся спортивная одежда": 50, "Топы": 20, "Майки": 20, "Поло": 20, "Джинсы": 20,
                 "Юбки": 20, "Платья": 20, "Рубашки": 20, "Деним": 20, "Вся пляжная одежда": 20, "Кепки": 30,
                 "Панамы": 20, "Солнцезащитные очки": 20}
            ids = []
            for k, v in d.items():
